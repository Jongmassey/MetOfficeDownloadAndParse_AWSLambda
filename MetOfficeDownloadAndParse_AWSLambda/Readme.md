...
```
    cd "MetOfficeDownloadAndParse_AWSLambda"
    dotnet restore
```

Execute unit tests
```
    cd "MetOfficeDownloadAndParse_AWSLambda/test/MetOfficeDownloadAndParse_AWSLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "MetOfficeDownloadAndParse_AWSLambda/src/MetOfficeDownloadAndParse_AWSLambda"
